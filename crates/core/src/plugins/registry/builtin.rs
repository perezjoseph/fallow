...
use super::super::{
    ...
    content_collections::ContentCollectionsPlugin, convex::ConvexPlugin, cspell::CspellPlugin,
    ...
    expo::ExpoPlugin, expo_router::ExpoRouterPlugin, fumadocs::FumadocsPlugin,
    gatsby::GatsbyPlugin, graphql_codegen::GraphqlCodegenPlugin, hardhat::HardhatPlugin,
    husky::HuskyPlugin, i18next::I18nextPlugin, jest::JestPlugin, k6::K6Plugin, karma::KarmaPlugin,
    ...
    mintlify::MintlifyPlugin, mocha::MochaPlugin, msw::MswPlugin, nestjs::NestJsPlugin,
    ...
    opencode::OpenCodePlugin, oxlint::OxlintPlugin, pandacss::PandaCssPlugin, parcel::ParcelPlugin,
